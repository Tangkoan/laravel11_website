                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('store.blog') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input id="blog_title" name="blog_title" class="form-control" type="text" placeholder="Blog Title">
                                    @error('blog_title')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="blog_tags" value="" class="form-control" type="text" data-role="tagsinput"> 
                                    @error('blog_tags')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="blog_description" id="elm1" rows="5" placeholder="Blog Description"></textarea>
