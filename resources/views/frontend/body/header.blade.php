...
@endphp
   ...
   <header>
    ...
    <li class="{{ ($route == 'home')? 'active' : '' }}"><a href="#">Home</a></li> {{-- {{ route('home') }}--}}

    <li class="{{ ($route == 'home.about')? 'active' : '' }}"><a href="#">About</a></li>{{--{{ route('home.about') }} --}}


    <li><a href="services-details.html">Services</a></li>

    <li class="{{ ($route == 'home.portfolio') ? 'active' : '' }}"><a href="#">Portfolio</a>{{-- {{ route('home.portfolio') }} --}}

    </li>

    <li class="{{ ($route == 'home.blog') ? 'active' : '' }}"><a href="#">Our Blog</a>{{-- {{ route('home.blog') }} --}}

    </li>
    <li class="{{ ($route == 'contact.me') ? 'active' : '' }}"><a href="#">contact me</a></li> {{-- {{ route('contact.me') }} --}}
    </ul>
    </div>
