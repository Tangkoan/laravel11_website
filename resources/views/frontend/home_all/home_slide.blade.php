...
<section class="banner">
    ...
    <img style="border-radius: 10px" src="{{ $homeslide->home_slide  }}" alt="">
    </div>
    </div>
    <div class="col-xl-5 col-lg-6">
    <div class="banner__content">
    <h2 class="title wow fadeInUp" style="color: rgb(249, 39, 35)" data-wow-delay=".2s"><span>{{ $homeslide->title  }}</h2>
